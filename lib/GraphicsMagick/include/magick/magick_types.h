...
#  endif // defined(WIN64)
  ...
  typedef signed long long  magick_int64_t;    /* int64_t */
  typedef unsigned long long magick_uint64_t;   /* uint64_t */

#  if defined(MAGICK_IMPLEMENTATION)

#  define MAGICK_INT32_F ""      /* %PRId32 */
#  define MAGICK_UINT32_F ""    /* %PRIu32 */
#  define MAGICK_INT64_F "I64"      /* %PRId64 */
#  define MAGICK_UINT64_F "I64"    /* %PRIu64 */
  ...
  */
  ...
  typedef unsigned long long magick_uintmax_t; /* uintmax_t */
#  define MAGICK_UINTMAX_F "I64"  /* %ju */

  typedef unsigned long long magick_uintptr_t; /* uintptr_t */
#  define MAGICK_UINTPTR_F "ll"  /* %tu */

  typedef long long magick_ptrdiff_t; /* ptrdiff_t */
#  define MAGICK_PTRDIFF_F "ll"  /* %td */

#  define MAGICK_SIZE_T_F "I64" /* %zu */
#  define MAGICK_SIZE_T unsigned long long     /* size_t */

#  define MAGICK_SSIZE_T_F "I64" /* %zd */
#  define MAGICK_SSIZE_T signed long long     /* ssize_t */
